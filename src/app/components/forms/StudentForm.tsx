...
const schema = z.object({
  ...
  phone: z.string().min(1, { message: "Phone must be at least 1 characters" }),
  address: z
    .string()
    .min(1, { message: "Address must be at least 1 characters" }),
  bloodType: z
    .string()
    .min(1, { message: "BloodType must be at least 1 characters" }),
  birthday: z.date({ message: "Birthday must be a date" }),
